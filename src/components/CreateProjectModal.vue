<template>
      ...
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="submitForm">
          <div class="form-group">
            ...
            <input id="projectName" v-model="projectData.projectName" type="text" required />
          </div>
          <div class="form-group">
            <label for="projectDescription">Описание проекта:</label>
            <textarea id="projectDescription" v-model="projectData.projectDescription" required></textarea>
          </div>
  ...
  export default {
    ...
    methods: {
      submitForm() {
        this.$emit('create', this.projectData); // Отправляем данные формы в родительский компонент
      },
      closeModal() {
